...
exports.categoriesRoutes.post('/', (0, validator_middleware_1.validator)({ schema: categories_dto_1.createCategorySchema, type: validator_middleware_1.ParamsType.BODY }), controller.create);
